...
impl<I: PartialEq, T> PartialEq for Interval<I, T>
{
    #[inline]
...
impl<'a, I: PrimInt, T> Iterator for IterFind<'a, I, T>
{
...
impl<'a, I: PrimInt, T: Clone> Iterator for IterDepth<'a, I, T>
{
